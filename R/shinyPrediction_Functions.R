...
#    groupCenterT[,feature] <- factor(as.character(groupCenterT[,feature]))
...
#    model_fitted <- as.data.frame(fitted(test))
...
#  if (!is.null(meta_train)) {
#    predicted_full[,colnames(meta_train)[1]] <- rownames(predicted_full)
